			...
			<?php $no=1;
				  foreach($list->result() as $row){
					  ...
					  <tr>
						...
						<td>
					       <input size="14" value="<?php echo $row->catatan?>"><button class="btn btn-info btn-xs" type="button" onclick="edit_catatan(<?php echo $row->id_number;?>,<?php echo $periode;?>)" data-toggle="tooltip" data-placement="top" title="ubah"><i class="fa fa-edit"></i></button>   
						</td>
						<td>
						...
						<td>
					       <input size="14"  value="<?php echo $row->catatan_siswa?>"><button class="btn btn-info btn-xs" type="button" onclick="edit_catatan_siswa(<?php echo $row->id_number;?>,<?php echo $periode;?>)" data-toggle="tooltip" data-placement="top" title="ubah"><i class="fa fa-edit"></i></button>   
						</td>
						<td>
