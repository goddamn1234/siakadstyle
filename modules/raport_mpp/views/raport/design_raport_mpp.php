	...
	<table border="0" Width="100%" class="tbl-main" cellpadding="2">
	    <?php 
	      ...
	      foreach($raport->result() as $rpt){
	         ...
	         if ($pel!=$rpt->nama_mapel){
	            ...
	            <tr>
	                <td colspan="6" style=" color:#fff;background:#001F60;">Syarat Lulus : <?php echo $syarat_lulus ?></td>
	            </tr>
	            <?php } ?>
	            <?php  }
	         } else {
		...
		<?php } ?>
           ...
           <tr style=""><td style="background:#BDBDBD;font-size:18px;height:40px"><b>Evaluasi Siswa</b></td><td colspan="5"><?php echo $rpt->evaluasi ?></td></tr>
           <?php } ?>
