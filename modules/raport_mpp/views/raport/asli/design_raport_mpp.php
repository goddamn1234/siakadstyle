	    ...
	    <?php 
	      ...
	      foreach($raport->result() as $rpt){
	         ...
	         <table border="0" Width="100%" class="tbl-main" cellpadding="2">
            	...
            	<tr>
            		<th width=200><?php echo $tip?></th><th width=80>KRITERIA</th><th colspan=2>INDIKATOR PENILAIAN</th><th width=100>HASIL</th><th width=410>CATATAN</th>
            	</tr>
		<?php } ?>
		        <tr>
		            <?php if ($beda==true){ ?>
		               <td rowspan="<?php echo $rpt->jml?>" style="">
		                   <div><?php echo $rpt->nama_mapel.' k='.$rpt->jml ?></div> 
		            ...
		            <?php if ($beda==true){ ?> 
		               <td rowspan="<?php echo $rpt->jml ?>"><?php if ($rpt->hasil=='Y') echo 'TERCAPAI'; else echo 'BELUM TERCAPAI';  ?></td>
