	...
	<div class="form-group">
        <div class="imageupload panel panel-default"  style="min-height:320px;">
                ...
                <div class="file-tab panel-body">
					...
					<?php echo img(array('src'=>'image/student/default.jpg','style'=>'display:block'));?>
	...
	<div class="col-md-9 col-sm-9 col-sm-12">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<input type="text" id="id_number" name="id_number" required="required" class="form-control number" placeholder="number Induk Siswa">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">NISN </label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="nisn" name="nisn" class="form-control number" placeholder="number Induk Siswa (Nasional)">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Nama Lengkap <span class="required">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
		...
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Tempat Lahir<span class="required">*</span></label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="birth_place" name="birth_place" required="required" class="form-control col-md-7 col-xs-12">
			</div>
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Tanggal Lahir <span class="required">*</span></label>
			<div class="col-md-3 col-sm-3 col-xs-12">
				<input type="text" id="birth_date" name="birth_date" required="required" class="form-control col-md-7 col-xs-12" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Alamat Rumah <span class="required">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
		...
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Telepon <span class="required">*</span></label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="phone1" name="phone1" required="required" class="form-control number">
			</div>
			<label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Telepon 2</label>
			<div class="col-md-4 col-sm-4 col-xs-12">
		...
		<div class="form-group">
			...
			<label class="control-label col-sm-2 col-sm-2 col-xs-12">Tanggal Masuk</label>
			<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="text" id="addm_date" name="addm_date" class="form-control" readonly placeholder="Addmision date">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2 col-sm-2 col-xs-12">Asal Sekolah <span style="color:red;">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
			<input type="text" class="form-control" id="asal_sekolah" name="asal_sekolah" placeholder="Asal Sekolah" required="required" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-sm-2 col-sm-2 col-xs-12">Kelamin<span style="color:red;">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
			<div class="switch-field">
			<input type="radio" id="switch_left" class="gender" name="gender" value="M"/>
			<label for="switch_left">Laki-Laki</label>
			<input type="radio" id="switch_right" class="gender" name="gender" value="F" />
			<label for="switch_right">Perempuan</label>
			</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-5">
				<button type="button" class="btn btn-success" id="save"><i class="fa fa-save"></i> Simpan</button>
            </div>
		</div>
