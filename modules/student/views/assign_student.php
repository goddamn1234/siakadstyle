...
function del(id){
	 Lobibox.confirm({
		 ...
		 callback: function ($this, type) {
			if (type === 'yes'){
				$.ajax({
					url :"<?php echo site_url()?>/student/delAssign/"+id,
					type:"post",
					success:function(){
					Lobibox.notify('success', {
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							...
							<?php foreach($kelas->result() as $row){?>
									<option value="<?php echo $row->id_kelas;?>"><?php echo $row->nama_kelas." &nbsp;&nbsp;&nbsp; (".$row->nama_jalur." | ".$row->nama_jenis." | ".$row->nama_jenjang.')';?></option>
							<?php }	?>
