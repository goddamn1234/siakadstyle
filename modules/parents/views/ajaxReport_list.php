        ...
        <table id="datatable3" class="table table-striped table-bordered">
			...
			<?php $no=1;
				  foreach($list2->result() as $row){?>
					...
					<!--	    <?php if ($row->pub=="Y"){ ?> -->
    				<!--		    <a href="<?php echo site_url()?>raport_proyek/create_raport/<?php echo  $row->murid?>/<?php echo  $row->periode?>" type="button" onClick="" class="btn btn-info btn-sm"> <i class="fa fa-file-pdf-o"> </i> </a> -->
    				<!--	        <button type="button" onClick="" class="btn btn-success btn-sm">XLSX</button>					-->
					<!--        <?php } else {?> -->
    				<!--	        <a onClick="" class="btn btn-default btn-sm" disabled> <i class="fa fa-file-pdf-o"> </i> </button> -->
					...
					<!--    </td> -->
					    <td valign="middle"  width="130px">
					        <?php if (($row->pub=="Y")&&($row->pub2=="Y")){ 
					           $keyFile = str_replace("/","",'Gab_'.$row->nperiode.$row->tahun_akademik.'_'.$row->murid);?>
