...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="form-group">
		...
		<?php echo img(array('id'=>'img-upload','src'=>'image/parent/'.$parent->image));?>
		</div>
		</div>
		...
		<div class="panel panel-default">
            ...
            <span class="input-group-btn">
                <span class="btn btn-default btn-file">
                    Browse… <input type="file" name="userfile2" id="userfile2">
                </span>
            </span>
            <input type="text" class="form-control" readonly>
        </div>
		 <?php echo img(array('id'=>'img-upload2','src'=>'image/signature/parent/'.$parent->image_ttd));?>
		</div>
		</div>
    </div>
	...
	<div class="col-md-9 col-sm-9 col-sm-12">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="hidden" id="id_user" name="id_user" value="<?php echo $parent->id_user;?>" >
				<input type="text" id="id_number" name="id_number" required="required" class="form-control number" value="<?php echo $parent->id_number;?>" >
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Full name <span class="required">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="full_name" name="full_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $parent->full_name;?> ">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Spouse name</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="spouse_name" name="spouse_name" class="form-control col-md-7 col-xs-12" value="<?php echo $parent->spouse_name;?>" >
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Birth Place <span class="required">*</span></label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="birth_place" name="birth_place" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $parent->birth_place;?>" >
			</div>
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Date of Birth <span class="required">*</span></label>
			<div class="col-md-3 col-sm-3 col-xs-12">
				<input type="text" id="birth_date" name="birth_date" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo date('Y-m-d',strtotime($parent->birth_date));?>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Home Address <span class="required">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<textarea name="address" id="address" required="required" class="form-control col-md-7 col-xs-12" placeholder="detail address"><?php echo $parent->address;?></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Phone <span class="required">*</span></label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="phone1" name="phone1" required="required" class="form-control" value="<?php echo $parent->phone1;?>" >
			</div>
			<label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Phone2</label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="phone2" name="phone2" class="form-control" value="<?php echo $parent->phone2;?>" >
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<select class="select2_multiple form-control" multiple="multiple" id="children" name="children[]">
						<?php
							$x = explode(',',$parent->parent_from);
							foreach($children->result() as $child){
								if(in_array($child->id_number,$x)){
									$flag = 'selected';
								}else{
									$flag ='';
								}
							echo "<option value='".$child->id_number."' ".$flag.">".$child->full_name." | ".$child->id_number."</option>";
							}
                          ?>
                        </select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="education" name="education" class="form-control col-md-7 col-xs-12" placeholder="Education" value="<?php echo $parent->education;?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="occupation" name="occupation" class="form-control col-md-7 col-xs-12" placeholder="Occupation" value="<?php echo $parent->occupation;?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="income" name="income" class="form-control col-md-7 col-xs-12 number" placeholder="Income" value="<?php echo $parent->income;?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<option value="<?php echo $parent->num_code;?>"><?php echo $parent->reg;?></option>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<option value="<?php echo $parent->id_religion;?>"><?php echo $parent->religion_name;?></option>
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<select name="role" id="role" class="form-control">
				<option value="<?php echo $parent->role;?>"><?php echo $parent->nama_role;?></option>
			</select>
			</div>
		</div>
		<div class="form-group">
...
$(document).ready(function() {
	...
	/*$.ajax({
		url :"<?php echo site_url();?>/parents/get_child/"+id,
		type:"get",
		dataType:"JSON",
		success:function(respon){
			$('.select2_multiple').select2().val([respon['parent_from']]);
		}
	})
	*/
	...
	$("#save").click(function(){
		...
		if(id_number != '' || role != '0' || full_name != '' || birth_place != '' || birth_date != '' || address != '' || phone != '' || nationality !='0' || religion != ''){
			...
			var file2 = $('#userfile2')[0].files[0];
				formdata.append('fFile2', file2);	
	...
	var $imageupload = $('#img-upload');
         $imageupload.imageupload();
    
    var $imageupload2 = $('#img-upload2');
