...
function edit(id){
	$.ajax({
			url :"<?php echo site_url();?>/parents/feditParent",
			type:"post",
			data:"id="+id,
...
function del(id){
	 Lobibox.confirm({
		 ...
		 callback: function ($this, type) {
			if (type === 'yes'){
				$.ajax({
					url :"<?php echo site_url()?>/parents/delparent/"+id,
					type:"post",
					success:function(){
...
function act(id){
			$.ajax({
					url :"<?php echo site_url()?>/parents/actuser/"+id,
					type:"post",
					success:function(){
					Lobibox.notify('success', {
...
function reset(id){
	$.ajax({
		url :"<?php echo site_url()?>/parents/resetpas/"+id,
		type:"post",
		success:function(){
			Lobibox.notify('success', {
