	...
	<table border="1" class="list">
        ...
        <?php $no++; } ?>
			...
			<?php if($fm->flag_fmp == 'pass' && $key == $flag_span['pass']['start'] ) {
				echo '<td rowspan="'.$flag_span['pass']['rowspan'].'" style="width: 2cm">'.ucfirst( $fm->flag_fmp).'</td>';
			}elseif($fm->flag_fmp == 'merit' && $key == $flag_span['merit']['start']){
				echo '<td rowspan="'.$flag_span['merit']['rowspan'].'" style="width: 2cm">'.ucfirst( $fm->flag_fmp).'</td>';
			}elseif($fm->flag_fmp == 'distinction' && $key == $flag_span['distinction']['start']){
				echo '<td rowspan="'.$flag_span['distinction']['rowspan'].'" style="width: 2cm">'.ucfirst( $fm->flag_fmp).'</td>';
			}  
			 ?>
			...
			<?php }else { ?>
				<td style="width:2.6cm;font-size:7;"><?php echo $fm->DISCOVERY; ?> </td>
			...
			<?php }else { ?>
				<td style="width:2.6cm;font-size:7;"><?php echo $fm->EXPLORATION; ?> <?php echo $fm->r_expl; ?></td>
			...
			<?php }else { ?>
				<td style="width:2.6cm;font-size:7;"><?php echo $fm->PRESENTATION; ?></td>
			...
			<?php if(empty($fm->PERSONALITY)) { ?>
				...
				<td style="width:0.2cm;background:#000;font-size:6;font-weight:700;">N</td>
			<?php }else { ?>
				<td style="width:2.6cm;font-size:7;"><?php echo $fm->PERSONALITY; ?> </td>
			...
			<?php if(empty($fm->ACHIEVEMENT)) { ?>
				...
				<td style="width:0.2cm;background:#000;font-size:6;font-weight:700;">N</td>
			<?php }else { ?>
				<td style="width:2.6cm;font-size:7;"><?php echo $fm->ACHIEVEMENT; ?> </td>
			...
			<?php } ?>
			<?php if($key == 0) { ?>
			<td rowspan="<?php echo count($raport_fmp); ?>" style="width: 1.9cm;font-size:7;">  <?php echo !empty($fm->keterangan) ? $fm->keterangan : 'no notes' ; ?> </td>
			<?php } ?>
		</tr>
		<?php } ?>
	</table>
