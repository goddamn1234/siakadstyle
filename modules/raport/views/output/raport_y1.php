...
<body>
	...
	?>>
		...
		<?php $j=1; foreach($rl['detail'] as $rd) { $batas++; 
				...
				if(strlen($rd->DISCOVERY) >= 150){$style_dis = "font-size:8.5px;";}else{$style_dis = "font-size:9px;";}
				if(strlen($rd->EXPLORATION) >= 150){$style_exp = "font-size:8.5px;";}else{$style_exp = "font-size:9px;";}
				if(strlen($rd->PRESENTATION) >= 150){$style_pre = "font-size:8.5px;";}else{$style_pre = "font-size:8.5px;";}
				if(strlen($rd->PERSONALITY) >= 150){$style_per = "font-size:8.5px;";}else{$style_per = "font-size:8.5px;";}
				if(strlen($rd->ACHIEVEMENT) >= 150){$style_ach = "font-size:8.5px;";}else{$style_ach = "font-size:8.5px;";}
