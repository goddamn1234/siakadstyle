...
<body>
	...
	<table border="1" class="list">
        ...
        <td rowspan="<?php echo count($raport_fmp); ?>" style="font-weight: 700;width: 2.6cm">  <?php echo $fm->nama_mapel; ?> </td>
        <?php $no++; } ?>
			...
			<?php if(empty($fm->DISCOVERY)) { ?>
				<td style="width:2.5cm;background:#000;font-size:6;">N</td>
				<td style="width:0.2px;background:#000;font-size:6;">N</td>
			<?php }else { ?>
				<td style="width:2.5cm;font-size:6;"><?php echo ucfirst( $fm->DISCOVERY); ?> </td>
			...
			<?php }else { ?>
				<td style="width:2.5cm;font-size:6;"><?php echo ucfirst($fm->EXPLORATION); ?> </td>
			...
			<?php }else { ?>
				<td style="width:2.5cm;font-size:6;"><?php echo ucfirst($fm->PRESENTATION); ?></td>
				<td style="width:0.2cm;font-size:6;font-weight:700;"><?php echo $fm->r_pres == 'Y' ? 'YES':'NO'; ?></td>
			<?php } ?>
			<?php if(empty($fm->PERSONALITY)) { ?>
				<td style="width:2.6cm;background:#000;font-size:6;">N</td>
				<td style="width:0.2cm;background:#000;font-size:6;font-weight:700;">N</td>
			<?php }else { ?>
				<td style="width:2.6cm;font-size:6;"><?php echo ucfirst($fm->PERSONALITY); ?> </td>
			...
			<?php if(empty($fm->ACHIEVEMENT)) { ?>
				...
				<td style="width:0.2cm;background:#000;font-size:6;font-weight:700;">N</td>
			<?php }else { ?>
				<td style="width:2.6cm;font-size:6;"><?php echo ucfirst($fm->ACHIEVEMENT); ?> </td>
	...
	<table border="1">
		...
		<tr class="bold">
			...
			<td align="center" style="width: 3cm; background: #ddd; padding: 3px; font-weight: 700;">PASS</td>
