...
function edit(id){
	$.ajax({
			url :"<?php echo site_url();?>/principal/feditprincipal",
			type:"post",
			data:"id="+id,
...
function del(id){
	 Lobibox.confirm({
		 ...
		 callback: function ($this, type) {
			if (type === 'yes'){
				$.ajax({
					url :"<?php echo site_url()?>/principal/delprincipal/"+id,
					type:"post",
					success:function(){
...
function act(id){
			$.ajax({
					url :"<?php echo site_url()?>/principal/actuser/"+id,
					type:"post",
					success:function(){
					Lobibox.notify('success', {
...
function reset(id){
	$.ajax({
		url :"<?php echo site_url()?>/principal/resetpas/"+id,
		type:"post",
		success:function(){
			Lobibox.notify('success', {
