	...
	<div class="form-group">
        <div class="imageupload panel panel-default"  style="min-height:320px;">
                ...
                <div class="file-tab panel-body">
					...
					<?php echo img(array('src'=>'image/principal/default.jpg','style'=>'display:block'));?>
        ...
        <div class="imageupload panel panel-default"  style="min-height:320px;">
                ...
                <div class="file-tab panel-body">
                    <label class="btn btn-default btn-file">
                        <span>Browse</span>
                        <!-- The file is stored here. -->
                        <input type="file" name="userfile_sign" id="userfile_sign">
                    </label>
					<?php echo img(array('src'=>'image/principal/default.jpg','style'=>'display:block'));?>
                    <button type="button" class="btn btn-default">Remove</button>
					<br>
	...
	<div class="col-md-9 col-sm-9 col-sm-12">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<input type="text" id="id_number" name="id_number" required="required" class="form-control number" placeholder="number Induk Kepegawain">
			</div>
		</div>
		<div class="form-group">
