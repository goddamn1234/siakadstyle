...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="form-group">
		...
		<?php echo img(array('id'=>'img-upload','src'=>'image/teacher/'.$teacher->image));?>
		</div>
		</div>
    </div>
	...
	<div class="col-md-9 col-sm-9 col-sm-12">
		...
		<div class="form-group">
			...
			<input type="hidden" id="id_user" name="id_user" required="required" value="<?php echo $teacher->id_user;?>" >
				<input type="text" id="id_number" name="id_number" required="required" class="form-control number" value="<?php echo $teacher->id_number;?>" readonly >
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Full name <span class="required">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="full_name" name="full_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $teacher->full_name;?>" >
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Spouse name</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="spouse_name" name="spouse_name" class="form-control col-md-7 col-xs-12" value="<?php echo $teacher->spouse_name;?>" >
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Birth Place <span class="required">*</span></label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="birth_place" name="birth_place" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $teacher->birth_place;?>" >
			</div>
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Date of Birth <span class="required">*</span></label>
			<div class="col-md-3 col-sm-3 col-xs-12">
				<input type="text" id="birth_date" name="birth_date" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo date('d-m-Y',strtotime($teacher->birth_date));?>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Home Address <span class="required">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
				<textarea name="address" id="address" required="required" class="form-control col-md-7 col-xs-12" placeholder="detail address"><?php echo $teacher->address;?></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Phone <span class="required">*</span></label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="phone1" name="phone1" required="required" class="form-control number" value="<?php echo $teacher->phone1;?>" >
			</div>
			<label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Phone2</label>
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" id="phone2" name="phone2" class="form-control number" value="<?php echo $teacher->phone2;?>" >
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2 col-sm-2 col-xs-12">KTP/SIM<span style="color:red;">*</span></label>
			<div class="col-md-9 col-sm-9 col-xs-12">
			<input type="text" class="form-control" id="ktp" name="ktp" placeholder="KTP/SIM Number" required="required" data-inputmask="'mask' : '9999999999999999'" value="<?php echo $teacher->no_identitas;?>" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="text" id="join_date" name="join_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($teacher->joining_date));?>" readonly >
			</div>
		</div>
		<div class="form-group">
			...
			<input type="radio" id="switch_left" class="gender" name="gender" value="M" <?php if($teacher->gender == "M"){echo 'checked';} ?>/>
			<label for="switch_left">Male</label>
			<input type="radio" id="switch_right" class="gender" name="gender" value="F" <?php if($teacher->gender == "F"){echo 'checked';} ?> />
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
			<input type="text" class="form-control" id="university" name="university" value="<?php echo $teacher->university;?>" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<option value="<?php echo $teacher->marital_status;?>"><?php echo $teacher->marital_status;?></option>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<option value="<?php echo $teacher->num_code;?>"><?php echo $teacher->reg;?></option>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<option value="<?php echo $teacher->id_religion;?>"><?php echo $teacher->religion_name;?></option>
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<select name="role" id="role" class="form-control">
				<option value="<?php echo $teacher->id_role;?>"><?php echo $teacher->nama_role;?></option>
			</select>
			</div>
		</div>
		<div class="form-group">
